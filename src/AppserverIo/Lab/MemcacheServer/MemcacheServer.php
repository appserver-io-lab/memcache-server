...
/**
 * AppserverIo\Lab\MemcacheServer\MemcacheServer
 *
 * NOTICE OF LICENSE
 *
...
class MemcacheServer implements CacheInterface
{
     ...
     *
     * @var \AppserverIo\Lab\MemcacheProtocol\CacheRequestInterface
     */
    protected $vo = null;
    ...
    */
     ...
     *
     * @param \AppserverIo\Lab\MemcacheProtocol\CacheRequestInterface $vo The VO with the data to handle
     *
     * @return void
     */
     ...
     *
     * @return \AppserverIo\Lab\MemcacheProtocol\CacheRequestInterface
     */
